...
def init_path(data_dir):
    global VOC_IMG_DIR, VOC_ANNO_DIR, VOC_ANNO_GRAY_DIR, VOC_TRAIN_TXT, VOC_VAL_TXT
    global SBD_ANNO_DIR, SBD_IMG_DIR, SBD_ANNO_PNG_DIR, SBD_ANNO_GRAY_DIR, SBD_TRAIN_TXT, SBD_VAL_TXT
    global VOC_TRAIN_LST_TXT, VOC_VAL_LST_TXT, VOC_AUG_TRAIN_LST_TXT
